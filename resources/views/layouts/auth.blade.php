...
<html lang="en">
  <head>
    ...
    ></script>
    <script
      src="https://kit.fontawesome.com/5ddb92922b.js"
      crossorigin="anonymous"
    ></script>
    ...
    <header>
      <nav>
        ...
        <div class="theNav">
          <div class="dropdown">
            <button
              class="btn btn-default dropdown-toggle other-btn"
              type="button"
              id="dropdownMenu2"
      ...
      <div class="nav-menu">
        ...
        <div class="sidenav">
          <ul>
            ...
            <li>
              <a href="udsettings.html">Settings</a>
            </li>
            <button class="btn btn-default create-event2">Logout</button>
          </ul>
        </div>
      </div>
    </header>
